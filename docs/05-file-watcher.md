...
> 注：本文为 legacy 文档。v2 的权威事件契约见 [`docs/v2/13-sse-event-dictionary.md`](docs/v2/13-sse-event-dictionary.md)，实现以 `DirectoryWatcherService` + `LibraryScanService.scanSpecificDirectoryAsync` 为准。
